...
class CompromiseGame 
{
     ...
     * @param noTies    If this is set to true, then the game does not stop when after `len` number of rounds if the players tie. It continues until one of the players scores more than the others. Its default value is false.
     * 
